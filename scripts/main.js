...
var firstLine =['Little kitten cries,', 'Spring frogs chirp with love,', 'Sad slug slides alone,',
 ...
 'Rain falls, the creeks rise,', 'Piglets dance for fun,','Raindrops on roses,', 'Whiskers on kittens,', 'Bright copper kettles',
...
'dandelions spreading seed,', 'ladybugs show off their spots,', 'winter makes abandoned death', 'storms washout bunny babies', 
'otters play and beavers work,', 'fields of corn drown in weavils', 'crabs crawl out of dead man\'s eyes', 'pandas lose their shit in snow,', 
'bobcat kittens play with mouse,'];
...
'dead fish bob and float.', 'puppies chew big sticks.', 'new year comes too soon.', 'lone wolf howls to mate.',
'hunter shoots own foot.', 'goldfish feast on toes.', 'children laugh for you.', 'dead rat floats downstream.', 'caterpillar cries.'];
